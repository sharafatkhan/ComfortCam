...
- (void) btnSetDatetime:(id)sender
{
    isSetOver=YES;
    if (isP2P) {
        int result=m_pChannelMgt->SetDateTime((char*)[m_strDID UTF8String], 0, m_timeZone, m_Timing, (char*)[m_timingSever UTF8String]);
...
- (void)switchActionlocal:(id)sender {
    ...
    if (isButtonOn) {
        ...
        if (isP2P) {
            m_pChannelMgt->SetDateTime((char*)[m_strDID UTF8String], now, interval, m_Timing, (char*)[m_timingSever UTF8String]);
        }else{
