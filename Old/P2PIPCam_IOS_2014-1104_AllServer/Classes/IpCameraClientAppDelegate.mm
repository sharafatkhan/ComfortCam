...
-(void)loginInBizSever{
    ...
    /*
     2:HYLXJUGEKBHCHUGLEDGOGQGNEEGFGRGPIHEJEIEKLMHWEREHEG
     1:HXLXJUGEKBHCHUGLEDGOGQGNEEGFGRGPIHEJEIEKLMHWEREHEG
     0:PCLXJUGEKBHCHUGLEDGOGQGNEEGFGRGPIHEJEIEKLMHWEREHEG
    */
    ...
    int ret1 = Biz_Init("AQTDPDPKEISQLVASPALSLULKSUPELRPNLPLOLQSSPCLXLNLM");
    ...
    /*
     ...
     pro: 020603001
    */
    strcpy(appInf.appleToken,[appToken UTF8String]);
    INT32 retl;
...
-(NSString*)getoID:(NSString*)deviceToken{
    ...
    int tLen=strlen(appTokens);
    NSLog(@"getoID...tLen=%d",tLen);
    char  oID[100]={0};
    char  a[2]={0};
