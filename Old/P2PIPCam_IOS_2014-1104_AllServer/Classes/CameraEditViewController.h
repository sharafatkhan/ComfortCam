...
@interface CameraEditViewController : UIViewController <UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource,ZXingDelegate, SearchAddCameraInfoProtocol, UINavigationBarDelegate> {    
