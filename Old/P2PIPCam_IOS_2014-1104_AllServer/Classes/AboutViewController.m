...
- (UITableViewCell *)tableView:(UITableView *)aTableView cellForRowAtIndexPath:(NSIndexPath *)anIndexPath
{
    ...
    if (anIndexPath.section==0) {
        ...
        switch (anIndexPath.row) {
            ...
            case 3:
                ...
                cell.labelVersion.text = @"1.0.0.02";
                break;
    ...
    }else if (anIndexPath.section == 2)
    {
        ...
        frame=cell.frame;
        cell.labelItem.text = @"P2PAPI";
        cell.labelVersion.text = @"1.0.0.01";
        cell1=cell;
    }
    else
    {
        ...
        button.frame = CGRectMake(40.0, 3.0, 130.0, 35.0);
        button.tag = 1;
        ...
        button2.frame = CGRectMake(210.0, 3.0, 130.0, 35.0);
        button2.tag = 2;
