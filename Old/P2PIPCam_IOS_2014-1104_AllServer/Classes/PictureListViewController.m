...
- (UITableViewCell *)tableView:(UITableView *)aTableView cellForRowAtIndexPath:(NSIndexPath *)anIndexPath
{
    ...
    if ([IpCameraClientAppDelegate isiPhone]) {
        ...
        cell.vidPicView1.labelTime.text=[strTime substringToIndex:8];
        if (!bean.isLoaded) {
        ...
        cell.vidPicView2.labelTime.text=[strTime substringToIndex:8];
        if (!bean2.isLoaded) {
        ...
        cell.vidPicView3.labelTime.text=[strTime substringToIndex:8];
        if (!bean3.isLoaded) {
        ...
        cell.vidPicView4.labelTime.text=[strTime substringToIndex:8];
        if (!bean4.isLoaded) {
        ...
        cell.vidPicView5.labelTime.text=[strTime substringToIndex:8];
        if (!bean5.isLoaded) {
        ...
        cell.vidPicView6.labelTime.text=[strTime substringToIndex:8];
        if (!bean6.isLoaded) {
        ...
        cell.vidPicView7.labelTime.text=[strTime substringToIndex:8];
        if (!bean7.isLoaded) {
        ...
        cell.vidPicView8.labelTime.text=[strTime substringToIndex:8];
        if (!bean8.isLoaded) {
