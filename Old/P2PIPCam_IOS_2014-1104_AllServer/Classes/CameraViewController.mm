...
//
    ...
    label.frame=CGRectMake(32, 0, 90, 30);
...
- (void)viewDidLoad
{
    ...
    NSString *strUserName = [[NSUserDefaults standardUserDefaults] valueForKey:@"subscriptionEndDate"];
    ...
    // voila!
    dateFromString = [dateFormatter dateFromString:strUserName];
    
    NSDate * dateOne = [NSDate date];
    
    if([dateFromString compare:dateOne] == NSOrderedAscending)
    {
        [self performSelector:@selector(showRenewAlert) withObject:nil afterDelay:15.0];
            }
